...
# ----- API Endpoints -----
@router.post("/process-file", response_model=ProcessResult)
async def process_file(
    ...
    try:
        ...
        # page_chunks = pymupdf4llm.to_markdown(file_path, write_images=True, image_path=image_path, image_format="jpg", page_chunks=True)
        ...
        for doc in docs:
            ids = attachment_vs.store_document_in_vector_db(doc)
